      ...
      <div class="container pt-70 pb-30">
            <div class="row border-bottom-black">
                  ...
                  <div class="col-sm-6 col-md-4">
                        ...
                        <div class="widget dark">
                              <h6 class="widget-title mb-0 text-gray-darkgray">Rejoignez-nous sur nos réseaux</h6>
            ...
            <div class="container pt-20 pb-20">
                  <div class="row">
                        <div class="col-md-6 sm-text-center">
                              <p class="font-11 text-black-777 m-0">Développé par <a class="border-bottom" target="_blank" href="https://w2days.com"> W2days</a>, tous
                                    droits réservés - 2024</p>
                        </div>
                  </div>
            </div>
      </div>
